...
public class EscoPersjScreen implements Screen  {
        ...
        public EscoPersjScreen(Game game) {
            ...
            createUI();
            Label title = new Label("Escoge Personaje", Zombivive.gameSkin,"big-black");
        ...
        private void createUI() {
            ...
            btnMap1 = new TextButton("Caballero", Zombivive.gameSkin);
            ...
            btnMap2 = new TextButton("Mago", Zombivive.gameSkin);
            ...
            btnMap2.addListener(new ClickListener() {
                ...
                public void clicked(InputEvent event, float x, float y) {
                    ...
                    game.setScreen(new EscoPersjScreen((Zombivive) game));
                }
            });
